...
export const HeroSection = () => {
  ...
  return <section id="hero" className="section-container relative">
      <SimpleBackground />
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        delay: 0.2
          ...
          delay: 1.2
            ...
            <Button onClick={scrollToContact} size="lg" className="bg-gradient-primary hover:scale-105 transition-transform duration-300 shadow-glow px-8 py-4 text-lg font-semibold">
              Let's Build Together
            </Button>
            
            <Button variant="outline" size="lg" className="border-primary/50 hover:bg-primary/10 hover:scale-105 transition-all duration-300 px-8 py-4 text-lg">
              Download Resume
            </Button>
          </motion.div>
